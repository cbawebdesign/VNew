    ...
    return (
        <div className="privacy-margin">
             <section id="contact" className={props.className}>
                ...
                This Privacy Policy describes Vestly Media Inc. practices for collecting, using, disclosing, maintaining and protecting your personal information on the media platforms we operate, including the Vestly Media Inc. app on the iOS platforms (the “App”), our Website, or any other platform on which you see this Privacy Policy (collectively, the “Services”). We will refer to our users as “you” in this Privacy Policy. This Privacy Policy is incorporated into, and part of, the Terms of Use (the “Terms of Use”), which governs your use of our Services.
...
1. Who We Are
We are Vestly Media Inc., a Delaware corporation with an address at 30 Chatham Rd Box G., Short Hills, NJ 07078 (“Vestly Media Inc.,” “we,” “our,” “us”).
...
Most of the information we collect is given to us by you through filling out forms, registering for an account, or otherwise providing information when asked. Occasionally, we collect information from your device which helps us better provide our services to you. Because we may change our website and the services we offer from time to time, the means and methods to provide us with personal information may also change. Depending on how you interact with us and use our services, the personal information we collect may vary.

We may process the following types of personal data about you, which we have grouped together as follows:

Identifiers This may include your name (first and last), a username (or similar identifier), data of birth, gender, and profile photo if you upload it. Contact Information This may include your email address, mailing address, telephone number. Transaction Information This may include information you provide for the purposes of sending payments to you. Technical Information This may include your IP address (which may identify your general geographic location), device identifier data, the type of device you use, your operating system and version, the URL’s of our web pages that you visit, the URL’s of referring and exiting pages, the pages you view, the time spent on a page, the number of clicks made, the platform type, and generalized, non-specific location data. Usage Information This may include information about the app features you use, your stock or crypto preferences, the types of games you play, how long you use our Services, and how you use our Services. Account Information This may include your username and password, your preferences, feedback and survey responses. Marketing and Communications Information This may include your communications preferences in receiving marketing from us and/or third parties. Geolocation Data We collect your geolocation data whenever you choose to access the wallet features and play our raffle and sweepstakes games. We use this data to determine which rewards to offer, and our legal obligations in that jurisdiction.
...
Request fulfillment of your order for virtual goods, services, or prize payment;
Request marketing be sent to you;
Enter a game, competition, promotion, or survey,
Provide us feedback, request support, or otherwise communicate with Us.
Automated Collection. As you interact with our Services, we may automatically collect Technical Information and Usage Information. We collect these categories of Personal Information by using cookies, SDK’s, web beacons, and other similar technologies. Third Parties or Public Sources. We may share and receive personal information about you from various third parties as follows:

Technical Information and Usage Information from the following parties:
Analytics Providers such as Google (privacy policy);
...
Publicly visible data, such as your social media and other information submitted to social media or other publicly available media.
...
Purpose/ActivityType of data (varies depending on circumstances)Lawful basis for processing including basis of legitimate interest To register you as a user of our Services.

Contact Information

Account Information

Performance of a contract with you.Notifying you about changes to our terms or Privacy Policy.Contact InformationNecessary to comply with a legal obligationTo enable you to participate in a game, contest, competition, survey, or similar event.
...
Necessary for our legitimate interests (for running our business, provision of administration and IT services, network security, to prevent fraud and in the context of a business reorganization or group restructuring exercise)To provide you with information and marketing communications about our products and services.
...
Consent To respond to customer service requests including order status and chat communications.
...
Promotional Offers From Vestly Media Inc. We may use any of the categories of personal information we collect to make decisions about what we think you may desire or need as our consumer. We will only make these marketing decisions if you agree to receive email marketing from us. In all cases, we allow you to opt-out of receiving marketing communications from us.

Interest Based Advertising. Vestly Media Inc. uses advertising to help fund our services and we utilize numerous advertising technology platforms to help deliver relevant advertising to you. Vestly Media Inc. and the technology service provider may collect, receive, or use your personal data in connection with our use of the platform in order to provide interest-based advertising to you. In such cases the advertiser is acting as a controller of the data for its own purposes.
...
Social Media Advertising. Vestly Media Inc. also runs other kinds of online ad campaigns on social networking websites and other non-Vestly Media Inc. websites and apps. Some of these ads may be based on information we have about users. If Vestly Media Inc. provides information to a website or app for these advertising purposes, the information may only be used to display the Vestly Media Inc. ad. Please see the privacy policy of the website or app where a Vestly Media Inc. ad is shown for more information about its privacy practices and privacy choices it may offer.
...
Protection of Vestly Media Inc. and Others. We may share personal information when we believe it is appropriate to enforce or apply our Terms of Service and other agreements; or protect the rights, property, or safety of Vestly Media Inc., our products and services, our users, or others. This includes exchanging information with other companies and organizations for fraud protection and risk reduction. This does not include selling, renting, sharing, or otherwise disclosing personal information of our customers for commercial purposes in violation of the commitments set forth in this Privacy Policy.
...
Vestly Media Inc. has its headquarters in the United States. Information we collect from you will be processed in the United States. When we transfer EU data subject’s personal information to third parties outside of the European Economic Area (EEA), we rely on appropriate suitable safeguards or specific derogations recognized under data protections law, including the GDPR. The European Commission has adopted standard data protection clauses, which provide safeguards for Personal information transferred outside of the EEA. We may use Standard Contractual Clauses when transferring Personal information from a country in the EEA to a country outside the EEA.
...
Short Hills, NJ 70708, United States

Attn: support

support@Vestlymedia.com            
                </p>
            </section>
        </div>
